...
export const SEED_TEMPLATES: SeedTemplate[] = [
  ...
  // ──────────────── HR (10) ────────────────
  {
    name: "Interview Scorecard",
    nameKo: "면접 평가표",
    description: "Structured interview feedback and hiring recommendation",
    descriptionKo: "구조화된 면접 피드백과 채용 추천",
    icon: "🧑‍💼",
    category: "hr",
    tags: ["interview", "hiring", "면접"],
    blocks: [h2("Candidate / 후보자"), p("Name:"), p("Role:"), h2("Evaluation / 평가"), bullet("Communication:", "Problem solving:", "Role fit:"), h2("Strengths / 강점"), bullet(""), h2("Concerns / 우려사항"), bullet(""), h2("Recommendation / 추천"), p("Strong hire / Hire / No hire")],
  },
  {
    name: "Onboarding Plan",
    nameKo: "온보딩 계획",
    description: "New hire onboarding checklist and milestones",
    descriptionKo: "신규 입사자 온보딩 체크리스트와 마일스톤",
    icon: "🚀",
    category: "hr",
    tags: ["onboarding", "new hire", "온보딩"],
    blocks: [h2("Week 1 / 첫째 주"), tasks("Account setup", "Team introductions", "Role expectations"), h2("Week 2 / 둘째 주"), tasks("Product overview", "Shadow sessions"), h2("30/60/90 Goals"), bullet("30 days:", "60 days:", "90 days:")],
  },
  {
    name: "Job Description",
    nameKo: "채용 공고",
    description: "Role summary, responsibilities, and requirements",
    descriptionKo: "직무 요약, 책임, 자격요건",
    icon: "📄",
    category: "hr",
    tags: ["job", "description", "채용"],
    blocks: [h2("Role Summary / 직무 소개"), p(), h2("Responsibilities / 주요 업무"), bullet(""), h2("Requirements / 자격 요건"), bullet(""), h2("Nice to Have / 우대 사항"), bullet(""), h2("Team & Benefits / 팀과 복지"), bullet("")],
  },
  {
    name: "Performance Review",
    nameKo: "성과 리뷰",
    description: "Quarterly performance review template",
    descriptionKo: "분기별 성과 리뷰 템플릿",
    icon: "📈",
    category: "hr",
    tags: ["performance", "review", "성과"],
    blocks: [h2("Achievements / 성과"), bullet(""), h2("Growth Areas / 성장 포인트"), bullet(""), h2("Manager Feedback / 매니저 피드백"), p(), h2("Employee Reflection / 자기 회고"), p(), h2("Next Quarter Goals / 다음 분기 목표"), tasks("")],
  },
  {
    name: "1:1 Meeting",
    nameKo: "원온원 미팅",
    description: "Manager and direct report check-in template",
    descriptionKo: "매니저와 구성원 간 체크인 템플릿",
    icon: "💬",
    category: "hr",
    tags: ["1:1", "manager", "원온원"],
    blocks: [h2("Wins / 잘된 점"), bullet(""), h2("Challenges / 어려움"), bullet(""), h2("Support Needed / 필요한 지원"), bullet(""), h2("Career Growth / 성장"), p(), h2("Action Items / 액션 아이템"), tasks("")],
  },
  {
    name: "Hiring Pipeline",
    nameKo: "채용 파이프라인",
    description: "Candidate tracking and stage management",
    descriptionKo: "지원자 추적 및 단계 관리",
    icon: "🧲",
    category: "hr",
    tags: ["pipeline", "candidate", "채용"],
    blocks: [h2("Open Roles / 오픈 포지션"), bullet(""), h2("Candidates in Review / 검토 중"), bullet(""), h2("Interview Loop / 면접 진행"), bullet(""), h2("Offers / 오퍼"), bullet(""), h2("Risks / 리스크"), bullet("")],
  },
  {
    name: "Employee Handbook",
    nameKo: "직원 핸드북",
    description: "Company policies and working norms",
    descriptionKo: "회사 정책과 업무 방식 안내",
    icon: "📘",
    category: "hr",
    tags: ["handbook", "policy", "정책"],
    blocks: [h2("Mission & Values / 미션과 가치"), p(), h2("Ways of Working / 일하는 방식"), bullet(""), h2("Time Off / 휴가"), bullet(""), h2("Benefits / 복지"), bullet(""), h2("Code of Conduct / 행동 강령"), bullet("")],
  },
  {
    name: "Compensation Review",
    nameKo: "보상 검토",
    description: "Salary and compensation planning template",
    descriptionKo: "연봉 및 보상 계획 템플릿",
    icon: "💸",
    category: "hr",
    tags: ["compensation", "salary", "보상"],
    blocks: [h2("Current Compensation / 현재 보상"), bullet("Base:", "Bonus:", "Equity:"), h2("Market Benchmark / 시장 벤치마크"), bullet(""), h2("Recommendation / 권장안"), p(), h2("Approval Notes / 승인 메모"), p()],
  },
  {
    name: "Leave Request",
    nameKo: "휴가 신청",
    description: "Time-off request and handoff plan",
    descriptionKo: "휴가 신청 및 인수인계 계획",
    icon: "🏖️",
    category: "hr",
    tags: ["leave", "pto", "휴가"],
    blocks: [h2("Dates / 일정"), bullet("Start:", "End:"), h2("Reason / 사유"), p(), h2("Coverage Plan / 커버 계획"), bullet("Owner:", "Pending work:", "Escalations:"), h2("Approval / 승인"), p()],
  },
  {
    name: "Learning & Development Plan",
    nameKo: "성장 개발 계획",
    description: "Skill growth plan with coaching goals",
    descriptionKo: "역량 성장 계획과 코칭 목표",
    icon: "🌱",
    category: "hr",
    tags: ["learning", "development", "성장"],
    blocks: [h2("Skill Focus / 핵심 역량"), bullet(""), h2("Learning Goals / 학습 목표"), tasks(""), h2("Support & Resources / 지원"), bullet(""), h2("Checkpoint Dates / 점검 일정"), bullet(""), h2("Success Signals / 성공 지표"), bullet("")],
  },
